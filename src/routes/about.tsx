...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MYKUTUB est né d'une volonté de donner une seconde vie aux livres islamiques." },
    ...
    <div className="bg-background">
      <section className="relative overflow-hidden bg-[oklch(0.28_0.06_155)] text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 md:px-8 py-20 md:py-32 text-center space-y-6">
          ...
          <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-black leading-tight">{t("about.title")}</h1>
          <p className="text-lg md:text-2xl text-white/85 max-w-3xl mx-auto leading-relaxed">{t("about.intro")}</p>
        </div>
      </section>

      <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="text-center mb-12 space-y-3">
          <h2 className="font-headline text-3xl md:text-5xl font-black text-primary">{t("about.missionTitle")}</h2>
      ...
      <section className="bg-card border-y border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-5">
            <h2 className="font-headline text-3xl md:text-5xl font-black text-primary">{t("about.storyTitle")}</h2>
            <p className="text-lg text-foreground/80 leading-relaxed">{t("about.storyP1")}</p>
            <p className="text-lg text-foreground/80 leading-relaxed">
              {t("about.storyP2_a")}<span className="font-bold text-secondary">MYKUTUB</span>{t("about.storyP2_b")}<span className="font-arabic text-2xl">كتب</span>{t("about.storyP2_c")}<strong>{t("about.storyP2_d")}</strong>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="text-center mb-12 space-y-3">
          <h2 className="font-headline text-3xl md:text-5xl font-black text-primary">{t("about.valuesTitle")}</h2>
      ...
      <section className="px-4 md:px-8 pb-20 md:pb-28">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-primary to-[oklch(0.45_0.08_180)] text-primary-foreground rounded-3xl p-10 md:p-16 text-center shadow-2xl">
          ...
          <h2 className="font-headline text-3xl md:text-5xl font-black mb-4 leading-tight">{t("about.ctaTitle")}</h2>
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto mb-8">{t("about.ctaText")}</p>
